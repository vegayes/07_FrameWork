        ...
        <section class="myPage-content">
            ...
            <section class="myPage-main">
                ...
                <form action="info" method="POST" name="myPageFrm"  id = "updateInfo">
                    ...
                    <%-- 구분자를 기준으로 배열을 만들건데 그 배열의 이름이 addr --%>
                    



                    <div class="myPage-row info-address">
                        <input type="text" name="memberAddress" placeholder="우편번호" id="update_postcode"
                        	value="${addr[0]}"
                        >
                    ...
                    <div class="myPage-row info-address">
                        <input type="text" name="memberAddress"  placeholder="도로명/지번 주소" id = "update_address"
                        	value="${addr[1]}">                
                    </div>

                    <div class="myPage-row info-address">
                        <input type="text" name="memberAddress"  placeholder="상세 주소" id = "update_detailAddress"
                        	value="${addr[2]}"
                        	>                
                    </div>
